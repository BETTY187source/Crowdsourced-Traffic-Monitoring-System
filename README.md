...
A crowdsourced traffic monitoring system built with Flask (Python) and React Native for mobile apps. This system collects real-time traffic data from users and provides insights on traffic conditions, alterna routes, and incident alerts, helping commuters navigate through urban areas efficiently.
